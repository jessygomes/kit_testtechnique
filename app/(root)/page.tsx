    ...
    <main className="relative">
      ...
      <section className="wrapper flex flex-col gap-2 justify-center z-10 relative h-[100vh]">
        <div className="w-full mt-[6rem] flex flex-col gap-4 justify-center items-center rounded-lg p-8 bg-primaryBlack bg-opacity-0 backdrop-filter backdrop-blur-sm">
          <h1 className="h1-bold text-white">Concevez votre kit à planter !</h1>
          <h2 className="text-[1rem] md:text-[1.5rem] text-left lg:text-center text-white">
            Choissisez les combinaisons qui vous conviennent entre nos
            différentes plantes et nos différents pots.
          </h2>
        </div>
